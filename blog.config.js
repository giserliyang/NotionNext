...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'liyang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一位有情怀的程序员，钻研技术，也喜欢体育。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.liyang.ac.cn', // 网站地址
  ...
  GREETING_WORDS:
    ...
    '您好，欢迎访问我的网站,我是李杨,我是一个程序员,欢迎来到我的博客🎉',
